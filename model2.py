...
class ChatBotModel:
    ...
    def preprocess(self):
        ...
        self.model_vocab = [self.lemmatizer.lemmatize(w.lower()) for w in self.model_vocab]
        ...
        for x, doc in enumerate(x_docs):
            bag = []
            wrds = [self.lemmatizer.lemmatize(w.lower()) for w in doc]
    ...
    def intializeModel(self):
        ...
        self.model.fit(training, output, n_epoch=24, batch_size=35, show_metric=True)
        self.model.save('./model_2/chatbot.tflearn')
    ...
    def loadModel(self):
        ...
        self.model = tflearn.DNN(net)
        self.model.load(model_file='model_2/chatbot.tflearn')
    ...
    def torkenize_user_query(self,user_inpt, vocabulary):
        ...
        user_wrds = [self.lemmatizer.lemmatize(word.lower()) for word in user_wrds]
